...
<template>
  ...
  >
    ...
    <template v-else>
      <div class="text-[13.5px] font-medium leading-[1.3] text-[var(--island-ink-3)]">Нет активного таймера</div>
      <div class="text-[11px] mt-[3px] text-[var(--island-ink-3)]">Запустите таймер в задаче</div>
    </template>
  </div>
</template>
