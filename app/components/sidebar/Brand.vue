...
<template>
  ...
  >
    <NuxtLink :to="pageRoutes.home" class="flex min-w-0 items-center gap-2.5">
      <span v-if="!collapsed" class="truncate text-base font-semibold tracking-tight text-highlighted">
        Scrumban
      </span>
    </NuxtLink>
    <button
