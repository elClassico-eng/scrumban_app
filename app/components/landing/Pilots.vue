  ...
  <section id="pilots" class="section pilots section--light">
    <div class="wrap">
      <div class="pilots__head reveal">
        ...
        <p>Я ищу пилотные команды, готовые попробовать ScrumBan в реальной работе. Не нужно мигрировать всю команду — достаточно одного проекта и честного «что не так». Ваш фидбек идёт прямо в разработку.</p>
      </div>
