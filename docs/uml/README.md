...
| 3 | `03-package/` | Package | Модульная организация `app/` + `server/` + `shared/` | Архитектура (TBD — следующая задача) |
...
Гэпы в нумерации (`03`, `05`) намеренные: `03-package/` появится в следующем коммите, `05-deployment/` — органически в Phase 5. См. [`theory.md`](theory.md) — краткий справочник по всем 14 типам UML-диаграмм (для главы «Анализ методологии моделирования» или «Обзор инструментов»).
