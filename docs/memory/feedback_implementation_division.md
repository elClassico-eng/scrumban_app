...
- **Phase 0 pet-project (notes-api):** пропущен. Plan-файл `2026-04-23-phase0-week1-nitro-starter.md` оставлен в репо как референс рабочего setup'а Nuxt+Nitro+Drizzle, но не исполняется как sequential learning plan.
